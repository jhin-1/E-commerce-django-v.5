...
@api_view(["GET"])
def open_size(request):
    call = SizeOop(request).open_size()
    re_status, re_message, re_data = call[0], call[1], call[2]
    re_send = {
        "message": re_message,
        "data": re_data,
...
def create_size(request):
    call = SizeOop(request).create_size()
    re_status, re_message, re_data = call[0], call[1], call[2]
    re_send = {
        "message": re_message,
        "data": re_data,
...
def update_size(request):
    call = SizeOop(request).update_size()
    re_status, re_message, re_data = call[0], call[1], call[2]
    re_send = {
        "message": re_message,
        "data": re_data,
...
def delete_size(request):
    call = SizeOop(request).delete_size()
    re_status, re_message = call[0], call[1]
    re_send = {
        "message": re_message
    }
...
def all_variants(request):
    call = VariantOop(request).all_variant()
    re_status, re_message, re_data = call[0], call[1], call[2]
    re_send = {
        "massage": re_message,
        "data": re_data,
...
def create_variant(request):
    call = VariantOop(request).create_variant()
    re_status, re_message, re_data = call[0], call[1], call[2]
    re_send = {
        "message": re_message,
        "data": re_data,
...
def update_variant(request):
    call = VariantOop(request).update_variant()
    re_status, re_message, re_data = call[0], call[1], call[2]
    re_send = {
        "message": re_message,
        "data": re_data,
